    ...
    chrome.tabs &&
      chrome.tabs.query(
        ...
        (tabs) => {
          ...
          const backgroundChannel = new BroadcastChannel('backgroundChannel');
          backgroundChannel.onmessage = (ev: any) => {
            console.log('fromBackground', ev);
          };

          backgroundChannel.postMessage('hello background. Im popup');
        }
      );
  }, []);
